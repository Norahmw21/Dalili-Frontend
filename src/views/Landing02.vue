  ...
  <section class="bg-white min-h-screen">
    ...
    <div class="flex flex-col lg:flex-row items-center justify-between px-8 py-16 max-w-7xl mx-auto">
      ...
      <div class="flex flex-col items-center justify-center text-center px-8 py-20 max-w-4xl mx-auto">
        ...
        <p class="text-gray-600 mb-8 max-w-xl text-lg">
          WELCOME TO <span class="font-bold text-gray-800">DALILI</span> — Your Trusted Companion For Finding The Right
          Doctor.
        </p>

        <button
            @click="$router.push('/login')"
            class="bg-gradient-to-r from-blue-600 to-teal-500 hover:from-blue-700 hover:to-teal-600
         text-white px-10 py-3 rounded-full font-semibold text-lg
    ...
    <section class="py-20 bg-gradient-to-b from-white to-gray-50">
      <div class="max-w-7xl mx-auto px-8">
        <!-- Why Choose Us Section -->
        <div
            class="flex flex-col lg:flex-row items-center justify-center gap-16 px-8 py-20 max-w-6xl mx-auto text-center lg:text-left">
          ...
          <div class="lg:w-2/3">
            ...
            <ul class="space-y-6">
              <li class="flex items-start justify-center lg:justify-start">
                <div
                    class="flex-shrink-0 w-10 h-10 bg-teal-500 rounded-full flex items-center justify-center mr-4 shadow-md">
