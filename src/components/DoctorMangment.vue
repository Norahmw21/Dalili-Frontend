        ...
        <div class="space-y-4">
          <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              ...
              <input v-model="editingDoctor.name" class="w-full p-2 rounded-lg border border-gray-300 focus:ring-2 focus:ring-blue-500" />
            </div>
            <div>
              <label class="block text-sm font-medium text-gray-700 mb-1">Photo URL:</label>
              <input v-model="editingDoctor.photoUrl" class="w-full p-2 rounded-lg border border-gray-300 focus:ring-2 focus:ring-blue-500" />
            </div>
            <div>
              <label class="block text-sm font-medium text-gray-700 mb-1">Phone:</label>
              <input v-model="editingDoctor.contactPhone" class="w-full p-2 rounded-lg border border-gray-300 focus:ring-2 focus:ring-blue-500" />
            </div>
            <div>
              <label class="block text-sm font-medium text-gray-700 mb-1">Email:</label>
              <input v-model="editingDoctor.contactEmail" class="w-full p-2 rounded-lg border border-gray-300 focus:ring-2 focus:ring-blue-500" />
            </div>
            <div>
              <label class="block text-sm font-medium text-gray-700 mb-1">Years of Experience:</label>
              <input type="number" v-model="editingDoctor.yearsOfExperience" class="w-full p-2 rounded-lg border border-gray-300 focus:ring-2 focus:ring-blue-500" />
            </div>
            <div>
              <label class="block text-sm font-medium text-gray-700 mb-1">Specialty:</label>
              <input v-model="editingDoctor.specialty" class="w-full p-2 rounded-lg border border-gray-300 focus:ring-2 focus:ring-blue-500" />
            </div>
            <div class="md:col-span-2">
              <label class="block text-sm font-medium text-gray-700 mb-1">Hospital:</label>
              <select v-model="editingDoctor.hospitalId" class="w-full p-2 rounded-lg border border-gray-300 focus:ring-2 focus:ring-blue-500">
          ...
          <div>
            ...
            <textarea v-model="editingDoctor.bio" class="w-full p-2 rounded-lg border border-gray-300 focus:ring-2 focus:ring-blue-500" rows="2"></textarea>
          </div>

          <div>
            <label class="block text-sm font-medium text-gray-700 mb-1">Experience:</label>
            <textarea v-model="editingDoctor.experience" class="w-full p-2 rounded-lg border border-gray-300 focus:ring-2 focus:ring-blue-500" rows="3"></textarea>
          </div>
